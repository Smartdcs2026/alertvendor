/*
 * vcw-workflow-api.js
 * VCW-R10B Frontend Workflow API Client
 *
 ...
 * - /api/workflow/modules/:moduleId/sync-gate-out
 * - /api/workflow/modules/:moduleId/gate-out-sync/preview
 * - /api/workflow/modules/:moduleId/gate-out-sync/run
 */
(function (window) {
  'use strict';
