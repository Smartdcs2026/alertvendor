/**
 * dashboard-shift.js
 * ROUND 62 — Professional Executive Shift Dashboard
 */
    ...
    const definitions = {
      ...
      shift: {
        ...
        items: [
          ...
          ['คงค้าง', 'จำนวนที่ยังอยู่ในพื้นที่เมื่อกะสิ้นสุดหรือ ณ เวลาปัจจุบัน'],
      ...
      flow: {
        ...
        items: [
          ...
          ['ปิดอัตโนมัติ', 'รายการที่ระบบปิดอัตโนมัติเมื่อเกินเวลาที่กำหนด'],
